...
this.op=op||{};
//options
this.op.l = document.documentElement.getAttribute("lang")||op.l||n["language"]||n["userLanguage"]||"en";
...
if (ll=="de")
	...
	t = '您使用的浏览器 (%s) 已经<b>过期了</b>。 这个版本的浏览器存在已知的<b>安全漏洞</b>，并且无法显示完整的网站页面\
    <a%s>了解如何升级您的浏览器</a>';
...
background:#FDF2AB no-repeat 10px center url(../img/dialog-warning.gif);\
