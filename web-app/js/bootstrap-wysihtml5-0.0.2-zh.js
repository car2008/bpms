	...
	var templates = {
		"font-styles": "<li class='dropdown'>" +
							"<a class='btn dropdown-toggle' data-toggle='dropdown' href='#'>" +
								"<i class='icon-font'></i>&nbsp;<span class='current-font'>正文</span>&nbsp;<b class='caret'></b>" +
							"</a>" +
		...
		"lists": 	"<li>" 
						+ "<div class='btn-group'>" 
						    ...
						    + "<a class='btn' data-wysihtml5-command='Outdent' title='升级'><i class='icon-indent-right'></i></a>"  							    
						    + "<a class='btn' data-wysihtml5-command='Indent' title='降级'><i class='icon-indent-left'></i></a>" 
						+ "</div>" 
					+ "</li>",
		...
		"link": 	"<li>" 
				    	...
				    	+ "<a class='btn' data-wysihtml5-command='createLink' title='插入链接'><i class='icon-share'></i></a>" 
			...
			"image": "<li>" 
						...
						+ "<a class='btn' data-wysihtml5-command='insertImage' title='插入图片'><i class='icon-picture'></i></a>" 
		...
		"html": 
						"<li>"
							+ "<div class='btn-group'>"
								+ "<a class='btn' data-wysihtml5-action='change_view' title='编辑HTML'><i class='icon-pencil'></i></a>" 
							+ "</div>"
						+ "</li>"
	};
